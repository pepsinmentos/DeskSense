...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *DeskSense*):
...
Execute unit tests
```
    cd "DeskSense/test/DeskSense.Tests"
    dotnet test
```

Deploy application
```
    cd "DeskSense/src/DeskSense"
